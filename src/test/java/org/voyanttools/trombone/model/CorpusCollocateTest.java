...
public class CorpusCollocateTest {
	...
	public void test() {
		...
		assertEquals(list.get(1).getNormalizedContextTerm(), "a");
		assertEquals(list.get(list.size()-1).getContextTermRawFrequency(), 8);
		...
		assertEquals(list.get(0).getContextTermRawFrequency(), 8);
		assertEquals(list.get(list.size()-2).getNormalizedContextTerm(), "c");
		...
		assertEquals(list.get(0).getNormalizedContextTerm(), "a");
		assertEquals(list.get(0).getContextTermRawFrequency(), 11);
		assertEquals(list.get(list.size()-1).getNormalizedContextTerm(), "d");
		assertEquals(list.get(list.size()-2).getNormalizedContextTerm(), "c");
		...
		assertEquals(list.get(0).getNormalizedContextTerm(), "d");
		assertEquals(list.get(1).getNormalizedContextTerm(), "c");
		assertEquals(list.get(1).getContextTermRawFrequency(), 12);
		assertEquals(list.get(list.size()-1).getNormalizedContextTerm(), "a");
		assertEquals(list.get(list.size()-1).getContextTermRawFrequency(), 10);
	}
